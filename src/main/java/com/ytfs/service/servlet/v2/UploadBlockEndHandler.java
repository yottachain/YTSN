...
public class UploadBlockEndHandler extends Handler<UploadBlockEndReqV2> {
    ...
    private List<ShardMeta> verify(UploadBlockEndReqV2 req, List<UploadShardRes> resList, long VBI) throws ServiceException, NoSuchAlgorithmException, NodeMgmtException {

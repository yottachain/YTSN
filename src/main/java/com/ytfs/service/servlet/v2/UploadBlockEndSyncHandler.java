...
public class UploadBlockEndSyncHandler extends Handler<UploadBlockEndSyncReqV2> {
    ...
    private List<ShardMeta> verify(UploadBlockEndSyncReqV2 req, List<UploadShardRes> resList, long VBI) throws ServiceException, NoSuchAlgorithmException, NodeMgmtException {
